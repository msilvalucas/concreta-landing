...
export function BenefitsSection() {
  ...
  return (
    <section className="container mx-auto py-8 px-4 sm:px-8 lg:px-24 bg-white" aria-labelledby="benefits-title"
    >
      <div className="flex flex-col sm:flex-row justify-center gap-2 mb-12">
        <button
          onClick={() => setActiveTab('individual')}
          className={`px-6 py-2 rounded-xl font-semibold transition-all duration-200 ${activeTab === 'individual'
        ...
        <button
          ...
          className={`px-6 py-2 rounded-xl font-semibold transition-all duration-200 ${activeTab === 'business'
            ? 'bg-blue-200 text-blue-900'
            : 'border border-black text-black'
            }`}
        >
      ...
      <h2
        id="benefits-title"
        className="text-center text-2xl md:text-3xl font-extrabold text-neutral-900 mb-10"
      >
            ...
            {data.map((benefit) => (
              <SwiperSlide key={benefit.id}>
                <div className="flex justify-center">
                  <Card title={benefit.title} description={benefit.description}>
                    <SvgIcon />
                  </Card>
                </div>
              </SwiperSlide>
